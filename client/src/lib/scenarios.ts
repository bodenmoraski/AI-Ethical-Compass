...
export async function submitPerspective(scenarioId: number, content: string, authorName: string = "Anonymous User", userId?: string, userEmail?: string, parentId?: number): Promise<Perspective> {
