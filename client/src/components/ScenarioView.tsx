...
const getDefaultSdgDetails = (sdgTags: string[]) => {
  const details = [];
  if (sdgTags.includes("4")) {
    details.push({
      goal: "Quality Education (SDG 4)",
      description: "Ensure inclusive and equitable quality education and promote lifelong learning opportunities for all.",
      relevance: "This scenario explores how AI technologies can impact educational quality, access, and equity.",
      icon: "school"
    });
  }
  if (sdgTags.includes("10")) {
    details.push({
      ...
      relevance: "This scenario examines how AI can either reduce or amplify existing inequalities in educational settings.",
      icon: "balance"
    });
  }
  return details;
      ...
      <div className="flex-1">
        ...
        <Card>
          <CardContent className="p-5 sm:p-6">
            ...
            <div className="mt-8">
              <SdgDetails 
                sdgDetails={currentScenario.sdgDetails?.length > 0 
                  ? currentScenario.sdgDetails 
                  : getDefaultSdgDetails(currentScenario.sdgTags)
                } 
              />
            </div>
